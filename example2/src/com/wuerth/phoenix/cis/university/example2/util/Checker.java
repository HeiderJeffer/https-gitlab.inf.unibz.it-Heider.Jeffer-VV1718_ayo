...
public class Checker {
	...
	protected Container createContainer(Scenario scenario, boolean merged, boolean afterImport) {
		...
		for(CombinationLine combinationLine : scenario.getCombination().getLineList()) {
			combinationParser.addIFRS16Contract(combinationLine);	
		}
	 ...
	 */
	public IFRS16Contract createIFRS16Contract(Settings settings, CombinationLine combinationLine) {
	...
	protected String getId(IFRS16Condition ifrs16Condition) {
		...
		return getId(ifrs16Condition, ifrs16Condition.getParentIFRS16Contract(), ifrs16ConditionData == null ? null : ifrs16ConditionData.getFromDate(), ifrs16ConditionData == null ? null : ifrs16ConditionData.getCostCenter());
	}
	...
	protected String getId(IFRS16ConditionData ifrs16ConditionData, IFRS16Condition ifrs16Condition) {
		return new StringBuffer()
				.append(getId(ifrs16Condition, ifrs16Condition.getParentIFRS16Contract(), ifrs16ConditionData.getFromDate(), ifrs16ConditionData.getCostCenter()))
				.append(ID_SEPARATOR)
